...
// Access Mongo Atlas DB in production mode, or local db in dev mode
  ...
  helmet.contentSecurityPolicy({
    directives: {
      ...
      imgSrc: [
        ...
        "blob:",
        "data:",
        "https://res.cloudinary.com/dakgl7s9n/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT!
...
const handleValidationErr = (err) => {
  console.log(
    `${err._message}. Cannot add campground - reason: ${err.errors.title.properties.message}`
  );
